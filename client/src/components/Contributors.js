      ...
      <div className="h-screen flex flex-col justify-center bg-red-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-1/2 bg-slate-500">
          {contributors.map((contributor) => (
            <div key={contributor.username} className="bg-white rounded-lg p-4 shadow-md">
              <img
              ...
              <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4  justify-center">
